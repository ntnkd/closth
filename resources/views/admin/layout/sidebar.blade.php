<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/admin/dashboard" class="brand-link">
      <img src="/template/admin/dist/img/AdminLTELogo.png" alt="Closth Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Closth</span>
    </a>
